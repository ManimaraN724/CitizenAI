...
Original file is located at
    https://colab.research.google.com/drive/1VCQrtwRGoK3uk29jjrSkR39-swyRaL8W
"""
...
# Citizen Services Function
def citizen_interaction(query):
    prompt = (
        "As a government assistant, provide accurate and helpful information about the following "
        "citizen query related to public services, government policies, or civic issues:\n\n"
        f"Query: {query}"
    )
    return generate_response(prompt, max_length=1000)
        ...
        with gr.Row():
            with gr.Column():
                city_input = gr.Textbox(
                    label="City Name",
                    placeholder="Enter city name: New York, London, Mumbai...",
                    lines=1
                )
